...
const SELECTION_STEPS = [
  {
    ...
    description:
      "Preencha seus dados para demonstrar interesse em participar do Hackathon AraraBots.",
  },
  {
    ...
    description:
      "Análise dos inscritos para definir os participantes que irão para o Hackathon.",
  },
  {
  ...
  },
  {
    ...
    date: "11/04/2026",
    description:
      "Maratona de inovação em robótica com Arduino e desenvolvimento de projetos.",
  },
  {
    ...
    date: "13/04/2026",
    description:
      "Divulgação dos novos membros aprovados para integrar a equipe AraraBots.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <Helmet>
        ...
        <meta
          name="description"
          content="Garanta seu lugar nos eventos e processos seletivos da equipe AraraBot."
        />
      </Helmet>
            ...
            <div className="lg:col-span-3 space-y-8">
              <div>
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 leading-tight break-words">
                  Faça parte do time{" "}
                  <span className="text-primary">ARARABOTS!</span>
                </h1>
                <p className="text-base sm:text-lg text-muted-foreground">
                  Entenda como funciona nossa jornada de seleção antes de
                  ...
                  >
                    ...
                    <div className="w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] p-3 sm:p-4 rounded-2xl bg-card/40 border border-white/5 backdrop-blur-sm transition-all hover:border-primary/30 hover:bg-card/60">
                      <div className="flex flex-col mb-1">
                        <span className="text-primary font-bold text-xs sm:text-sm tracking-wide uppercase">
                          {step.date}
                        </span>
